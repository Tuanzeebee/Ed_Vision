...
for (const line of lines) {
    const isStarter = parser.isQuestionStarter ? parser.isQuestionStarter(line) : "N/A";
    if (isStarter) {
        console.log(`Line: ${line} | Starter: ${JSON.stringify(isStarter)}`);
    }
}
//# sourceMappingURL=test-parser2.js.map