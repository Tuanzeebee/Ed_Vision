...
async function main() {
  ...
  const permissionDefs = [
    ...
    // System management
    {
      ...
      name: 'Manage Permission Definitions',
      category: 'admin',
    },
    {
    ...
    {
      key: 'admin_teacher_subjects',
      name: 'Teacher Subjects',
      category: 'admin',
    },
    {
      key: 'admin_teacher_ratings',
      name: 'Teacher Ratings',
      category: 'admin',
    },
    {
      key: 'admin_teacher_performance',
      name: 'Teacher Performance',
      category: 'admin',
    },
    {
      key: 'admin_teacher_schedule',
      name: 'Teacher Schedule',
      category: 'admin',
    },
    {
      key: 'admin_teacher_support_history',
      name: 'Teacher Support History',
      category: 'admin',
    },
    ...
    {
      key: 'teacher_prediction_view',
      name: 'Prediction View',
      category: 'teacher',
    },
    {
      key: 'teacher_progress_tracking',
      name: 'Progress Tracking',
      category: 'teacher',
    },
    {
      key: 'teacher_reports_alerts',
      name: 'Reports & Alerts',
      category: 'teacher',
    },
    {
    ...
    {
      key: 'teacher_appointments',
      name: 'Manage Appointments',
      category: 'teacher',
    },
    { key: 'teacher_settings', name: 'Teacher Settings', category: 'teacher' },
    {
      key: 'teacher_meeting_demo',
      name: 'Meeting Detail Demo',
      category: 'teacher',
    },
  ...
  { key: 'teacher_profile',           name: 'Teacher Profile',                category: 'teacher' },
    ...
    {
      key: 'parent_book_appointment',
      name: 'Book Appointment',
      category: 'parent',
    },
    {
      key: 'parent_appointments',
      name: 'Parent Appointments',
      category: 'parent',
    },
    {
      key: 'parent_student_details',
  ...
  const adminRoleRec = await prisma.role.findUnique({
    where: { code: 'admin' },
  });
  if (adminRoleRec) {
  ...
  const teacherRoleRec = await prisma.role.findUnique({
    where: { code: 'teacher' },
  });
  if (teacherRoleRec) {
    let teacherAcc = await prisma.account.findUnique({
  ...
  const studentRoleRec = await prisma.role.findUnique({
    where: { code: 'student' },
  });
  if (studentRoleRec) {
    let studentAcc = await prisma.account.findUnique({
  ...
  const parentRoleRec = await prisma.role.findUnique({
    where: { code: 'parent' },
  });
  if (parentRoleRec) {
    let parentAcc = await prisma.account.findUnique({
