...
import { DiagnosticAnalyzeRequestDto, RecommendPlanRequestDto } from './dto/learning-path.dto';
...
export class LearningPathController {
  ...
  async recommendPlan(@Body() dto: RecommendPlanRequestDto, @Req() req: any) {
    ...
    const mockDiagnosticResults = {
      gap: 200,
      skills: [
        { skill: 'Grammar', subSkill: 'Tense', masteryScore: 30, confidence: 0.9, weakness: 70 },
        { skill: 'Listening', subSkill: 'Part 1', masteryScore: 60, confidence: 0.8, weakness: 40 },
      ]
    };
