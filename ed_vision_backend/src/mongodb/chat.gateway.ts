...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    handleRegister(
        ...
        this.logger.log(`✅ User registered: ${data.userId} (${data.userType}) - Socket: ${client.id}`);
    ...
    async handleMessage(
        ...
        this.logger.log(`📨 Received message from ${data.senderId} in conversation ${data.conversationId}`);
