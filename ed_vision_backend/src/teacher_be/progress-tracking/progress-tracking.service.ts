...
export class ProgressTrackingService {
    ...
    async getProgressTracking(
        ...
        const comparisonWithPrevious = previousMilestone
            ? {
                ...
                atRiskChange:
                    currentMilestone.overview.atRisk - previousMilestone.overview.atRisk,
            }
            : {
                gpaChange: 0,
                attendanceChange: 0,
        ...
        const allStudents = await this.prisma.student.findMany({
            ...
            include: {
                ...
                courseRecords: {
                    where: {
                        academicTerm: {
                            academic_year: filterDto.academicYear || `${currentYear}-${currentYear + 1}`,
    ...
    private async createMilestone(
        ...
        const overview = this.calculateMilestoneOverview(
            students,
            progressFactor,
        );
