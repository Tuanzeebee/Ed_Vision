    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md p-0 overflow-hidden rounded-xl">
        ...
        <div className="px-6 py-5 text-center border-b border-gray-200">
          ...
          <p className="mt-2 text-sm text-gray-500">Sử dụng mã này để đăng ký tài khoản phụ huynh
          </p>
        </div>
        ...
        <div className="px-6 py-8">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 border-2 border-blue-200">
            <div className="text-center">
              <p className="text-xs font-medium text-gray-600 uppercase tracking-wider mb-3">Mã đăng ký
              </p>
