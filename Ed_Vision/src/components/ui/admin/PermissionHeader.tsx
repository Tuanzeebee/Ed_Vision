      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-3">
          <button 
            ...
            <span className="mr-1"></span>Hoàn tác
          </button>
          <button 
            ...
            <span className="mr-1"></span>Xuất cấu hình
          </button>
          <button 
            ...
            <span className="mr-1"></span>Lưu thay đổi
          </button>
        </div>
      </div>
        ...
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            ...
            <button 
              ...
              className={`border-b-2 py-2 px-1 text-sm font-medium transition-colors ${
                activeTab === 'role'? 'border-blue-500 text-blue-600': 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >Theo vai trò
            </button>
          </nav>
        </div>
          ...
          <CardContent className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3">
              <div>
                ...
                <input 
                  type="text"placeholder={activeTab === 'account'? "Tên tài khoản hoặc Email...": "Tên vai trò hoặc mô tả..."} 
                  className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-xs text-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"value={filters.searchTerm}
              ...
              <div>
                ...
                <select 
                  className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-xs text-gray-800 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"value={filters.accountTypeFilter}
              ...
              <div>
                ...
                <select 
                  className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-xs text-gray-800 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"value={filters.schoolFilter}
              ...
              <div>
                ...
                <select 
                  className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-xs text-gray-800 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"value={filters.majorFilter}
              ...
              <div>
                ...
                <select 
                  className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-xs text-gray-800 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"value={filters.statusFilter}
              ...
              <div>
                ...
                <select 
                  className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-xs text-gray-800 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"value={filters.permissionDisplayFilter}
