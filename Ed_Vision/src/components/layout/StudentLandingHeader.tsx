        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/student/login">
              <Button 
                variant="ghost" 
                className="text-gray-700 hover:text-purple-500 hover:bg-purple-50 px-4 py-2"
              >
                Login
              </Button>
            </Link>
            <Link to="/student/register">
              <Button 
                className="bg-gradient-to-r from-purple-500 to-blue-500 text-white hover:from-purple-600 hover:to-blue-600 px-6 py-2"
              >
                Register
              </Button>
            </Link>
