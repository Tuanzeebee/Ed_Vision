      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              type="text"value={formData.studentCode || ''}
              onChange={(e) =>setFormData({ ...formData, studentCode: e.target.value })}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white !text-gray-900"placeholder={t('studentAcademic.studentCodePlaceholder')}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white !text-gray-900"placeholder={t('studentAcademic.majorPlaceholder')}
            />
          </div>
          ...
          <div>
            ...
            <input
              type="number"value={formData.cohortYear || ''}
              onChange={(e) =>setFormData({ ...formData, cohortYear: e.target.value ? parseInt(e.target.value) : null })}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white !text-gray-900"placeholder={t('studentAcademic.cohortYearPlaceholder')}
              min="2000"max="2100"/>
          </div>
