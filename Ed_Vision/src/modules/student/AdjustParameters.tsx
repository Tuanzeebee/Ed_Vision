...
export default function AdjustParameters({}: Props) {
  ...
  const gpaSticky = useMemo(() => {
    ...
    const note = gpaValue >= 3.8
      ? '🌟 Siêu xuất sắc! Bạn là hình mẫu của nỗ lực! Duy trì thói quen học tập hiệu quả, thử chinh phục các học phần khó để tạo bứt phá. Chia sẻ kinh nghiệm với bạn bè để lan tỏa cảm hứng nhé!'
      : gpaValue >= 3.6
      ? '🌟 Xuất sắc! Tiếp tục bứt phá nhé! Giữ nhịp học đều, tối ưu thời gian cho môn trọng điểm và đặt mục tiêu tăng thêm 0.1–0.2 GPA kỳ tới. Bạn làm được!'
      : gpaValue >= 3.2
      ? 'Giỏi! Giữ vững phong độ! Chủ động ôn tập theo tuần, luyện bài ở phần còn yếu và tổng kết sau mỗi buổi. Thêm chút kỷ luật là lên mức xuất sắc ngay!'
      : gpaValue >= 2.8
      ? 'Khá tốt! Thêm chút kỷ luật là lên hạng! Lập kế hoạch 2–3 giờ/tuần cho môn khó, chia nhỏ mục tiêu và kiểm tra tiến độ mỗi tuần. Cứ đều đặn là vượt mốc 3.2 sớm thôi!'
      : gpaValue >= 2.5
      ? 'Khá! Cố gắng thêm chút nữa là lên hạng! Tập trung củng cố nền tảng, hỏi giảng viên/kết nối bạn học khi vướng mắc. Đặt mục tiêu tăng 0.2 GPA kỳ tới nhé!'
      : 'Bạn có thể làm tốt hơn! Lập kế hoạch nhỏ mỗi ngày 💪 Bắt đầu bằng mục tiêu tăng 0.2 GPA kỳ tới, học đều, ngủ đủ và nhờ hỗ trợ khi cần. Từng bước nhỏ tạo khác biệt lớn!'
