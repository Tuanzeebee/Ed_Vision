...
export default function PomodoroCompactWidget({
  ...
  const widget = (
    <div
      className="fixed top-3 left-1/2 -translate-x-1/2 z-50"onMouseEnter={() => {
        setHoverStage(1);
          ...
          <div className="px-3 pb-3">
            ...
            <div className="mt-2 flex items-center">
              <div className="relative w-full h-1.5 bg-white/10 rounded-full overflow-hidden transition-opacity duration-1000 ease-in-out opacity-100">
                <div
                  className="h-full bg-gradient-to-r from-orange-500 to-amber-500 transition-all"style={{ width: `${progress}%` }}
                />
              </div>
