            ...
            <div>
              ...
              <div className="flex gap-4 mt-1 text-sm text-white/70">
                <span className="flex items-center gap-1">
                  <i className="far fa-clock"></i>Thời lượng tối đa
                </span>
                <span className="flex items-center gap-1">
                  <i className="far fa-file-alt"></i>Những nội bật đầu
                </span>
                <span className="flex items-center gap-1">
                  <i className="far fa-list-alt"></i>Học giải bài
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto scrollbar-none">
            ...
            <div className="mb-3">
                    ...
                    <div key={stepNumber} className="flex items-center">
                        ...
                        {isLastStep ? (
                          ...
                          <div
                            className={`w-7 h-7 flex items-center justify-center transition-all duration-300 ${
                              isComplete
                                ...
                                ? 'text-purple-400 animate-bounce': 'text-white/40'}`}
                          >
                          ...
                          <div
                            className={`w-7 h-7 rounded-full flex items-center justify-center transition-all duration-300 border ${
                              isComplete
                                ? 'bg-purple-500 border-purple-500': isActive
                                ? 'bg-purple-500 border-purple-500 ring-2 ring-purple-300/50': 'bg-white/10 border-white/30'}`}
                          >
                            {isComplete ? (
                              <i className="fas fa-check text-white text-xs"></i>) : isActive ? (
                      ...
                      {index < lessons.length - 1 && (
                        <div className="w-12 h-0.5 mx-1 bg-white/20 relative overflow-hidden">
                          <motion.div
                            className="absolute inset-0 bg-purple-500"initial={{ width: '0%'}}
              ...
              <div className="mt-2 text-center">
                <motion.p
                  ...
                  className="text-white/90 font-medium text-xs">Lesson {currentStep} of {totalSteps}
                </motion.p>
              </div>
            </div>
            ...
            {currentLessonType === 'video'&& (
              <div className="relative rounded-xl overflow-hidden shadow-2xl mb-4 group"style={{ aspectRatio: '16/9'}}>
                <img
                  src="https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=1920&h=1080&fit=crop"alt="Learning content"className="w-full h-full object-cover"/>
              ...
              <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 mb-4 border border-white/10">
                {!isQuizStarted ? (
                  ...
                  <>
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg p-5 border border-blue-400/30">
                        <h4 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                          <i className="fas fa-info-circle text-blue-300"></i>Thông tin bài kiểm tra
                        </h4>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h5 className="text-white font-semibold mb-3 flex items-center gap-2">
                          <i className="fas fa-book-open text-purple-300"></i>Hướng dẫn làm bài
                        </h5>
                    ...
                    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                      <h5 className="text-white font-semibold mb-3 flex items-center gap-2">
                        <i className="fas fa-history text-blue-300"></i>Lịch sử làm bài
                      </h5>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <h4 className="text-lg font-semibold text-white flex items-center gap-2">
                        <i className="fas fa-list-check text-purple-300"></i>Xem lại đáp án
                      </h4>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-300"style={{ width: `${((currentQuestionIndex + 1) / quizQuestions.length) * 100}%` }}
                      ></div>
                    </div>
                          ...
                          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg p-5 border border-blue-400/30">
                            ...
                            <div className="space-y-3">
                              {currentQ.type === 'multiple-choice'|| currentQ.type === 'true-false'? (
                                  ...
                                  <button
                                    ...
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                      quizAnswers[currentQ.id] === option
                                        ? 'border-purple-500 bg-purple-500/20': 'border-white/20 bg-white/5 hover:bg-white/10'}`}
                                  >
                                    <div className="flex items-center gap-3">
                                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        quizAnswers[currentQ.id] === option
                                          ? 'border-purple-500 bg-purple-500': 'border-white/40'}`}>
                                        {quizAnswers[currentQ.id] === option && (
                                ...
                                /* Fill in the blank */
                                <input
                                  type="text"value={(quizAnswers[currentQ.id] as string) || ''}
                                  onChange={(e) =>handleQuizAnswer(currentQ.id, e.target.value)}
                                  placeholder="Nhập câu trả lời của bạn..."className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 focus:border-purple-400 focus:ring-2 focus:ring-purple-300/50 outline-none text-white placeholder-white/50"/>)}
                            </div>
                          </div>
                        </div>);
                    })()}
                    ...
                    <div className="flex items-center justify-between">
                      <button
                        ...
                        className={`px-6 py-3 rounded-lg transition-all font-semibold flex items-center gap-2 ${
                          currentQuestionIndex === 0
                            ? 'bg-white/5 text-white/30 cursor-not-allowed': 'bg-white/10 hover:bg-white/20 text-white'}`}
                      >
                      ...
                      {currentQuestionIndex === quizQuestions.length - 1 ? (
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg transition-all font-semibold flex items-center gap-2">Câu tiếp
                    ...
                    <div className="bg-white/5 rounded-lg p-3 border border-white/10">
                      <h5 className="text-white font-semibold mb-2 text-xs flex items-center gap-2">
                        <i className="fas fa-th text-purple-300"></i>Danh sách câu hỏi
                      </h5>
                          ...
                          <button
                            ...
                            className={`w-10 h-10 rounded-lg flex items-center justify-center text-sm font-semibold transition-all ${
                              idx === currentQuestionIndex
                                ? 'bg-purple-500 text-white ring-2 ring-purple-300 shadow-lg': quizAnswers[q.id]
                                ? 'bg-green-500/30 text-green-300 border border-green-500/50': 'bg-white/10 text-white/60 hover:bg-white/20'}`}
                          >
                            {idx + 1}
                          </button>))}
                      </div>
            ...
            <div className="flex items-center justify-between mb-4">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors text-white border border-white/20 ${
                  currentStep === 1
                    ? 'bg-white/5 opacity-50 cursor-not-allowed': 'bg-white/10 hover:bg-white/20'}`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-2 rounded-lg transition-all text-white font-medium ${
                  currentStep === totalSteps
                    ? 'bg-gradient-to-r from-purple-400 to-blue-400 opacity-50 cursor-not-allowed': 'bg-gradient-to-r from-purple-500 to-blue-500 hover:shadow-lg'}`}
              >
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-4 mb-4 border border-white/10">
              ...
              <div className={`text-sm text-white/80 leading-relaxed ${!isDescriptionExpanded ? 'line-clamp-2': ''}`}>
                <p>Trong khóa học này, bạn sẽ được khám phá những kiến thức nền tảng về Trí tuệ nhân tạo (AI) và cách mà công nghệ này đang thay đổi thế giới xung quanh chúng ta. Chúng ta sẽ cùng tìm hiểu về các khái niệm cơ bản, ứng dụng thực tế trong cuộc sống hàng ngày và công việc, cũng như những kỹ năng cần thiết để có thể làm việc hiệu quả với các công cụ AI hiện đại. Khóa học được thiết kế phù hợp cho người mới bắt đầu, không yêu cầu kiến thức lập trình hay toán học nâng cao. Bạn sẽ được thực hành với các công cụ AI phổ biến và học cách áp dụng chúng vào công việc và cuộc sống của mình một cách hiệu quả nhất.
                </p>
              </div>
              <button
            ...
            <div className="flex border-b border-white/20 bg-black/10">
              <button
                ...
                className={`flex-1 py-3 px-4 text-sm font-medium transition-colors ${
                  activeTab === 'content'? 'text-white border-b-2 border-purple-400': 'text-white/70 hover:text-white'}`}
              >Course content
              </button>
              <button
                onClick={() =>setActiveTab('transcript')}
                className={`flex-1 py-3 px-4 text-sm font-medium transition-colors ${
                  activeTab === 'transcript'? 'text-white border-b-2 border-purple-400': 'text-white/70 hover:text-white'}`}
              >Transcript
              </button>
              <button
                onClick={() =>setActiveTab('notes')}
                className={`flex-1 py-3 px-4 text-sm font-medium transition-colors ${
                  activeTab === 'notes'? 'text-white border-b-2 border-purple-400': 'text-white/70 hover:text-white'}`}
              >Notes
              </button>
            </div>
                            ...
                            {section.lessons.map((lesson) =>(
                              <div
                                ...
                                <div className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                                  lesson.isQuiz
                                    ? 'bg-blue-500/20 border border-blue-500/50': lesson.completed
                                    ? 'bg-green-500/20 border border-green-500/50': 'bg-white/10 border border-white/30'}`}>
                                  {lesson.isQuiz ? (
                                    <i className="fas fa-clipboard-question text-blue-400 text-[10px]"></i>) : lesson.completed ? (
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="mb-4 bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                    ...
                    <textarea
                      ...
                      placeholder="Write your note at this timestamp..."className="w-full px-3 py-2 rounded-lg bg-white/10 border border-white/20 focus:border-purple-400 focus:ring-2 focus:ring-purple-300/50 outline-none text-sm text-white placeholder-white/50 backdrop-blur-sm resize-none"rows={3}
                    />
                    <button
                  ...
                  <div className="flex-1 space-y-3">
                    <h4 className="text-sm font-semibold text-white/80 mb-2 flex items-center gap-2">
                      <i className="fas fa-sticky-note"></i>My Notes ({notes.length})
                    </h4>
                    {notes.length === 0 ? (
