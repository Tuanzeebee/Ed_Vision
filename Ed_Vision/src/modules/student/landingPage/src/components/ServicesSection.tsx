        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, i) => (
            <motion.button
              ...
              className="liquid-glass rounded-3xl overflow-hidden group hover:shadow-2xl transition-all duration-500 bg-white/20 border border-black/5 text-left w-full cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0D212C]/40"
            >
              ...
              <div className="p-8 md:p-10">
                <div className="flex items-center justify-between mb-6">
                  <span className="uppercase tracking-[0.2em] text-[#0D212C]/40 text-[10px] font-bold">
                    {service.tag}
                  </span>
                ...
                <h3 className="text-[#0D212C] text-2xl md:text-3xl font-medium mb-3 tracking-tight">
                  {service.title}
                </h3>
                <p className="text-[#0D212C]/50 text-sm md:text-base leading-relaxed max-w-[90%]">
                  {service.description}
                </p>
              </div>
            </motion.button>
