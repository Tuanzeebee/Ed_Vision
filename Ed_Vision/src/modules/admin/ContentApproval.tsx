      ...
      tooltip: {
        ...
        callbacks: {
          label: function(context: TooltipItem<'bar'>) {
            return (context.dataset.label || '') + ': ' + context.parsed.y + ' nội dung';
          }
        }
      }
    },
      ...
      <div className="p-6 bg-gray-50 overflow-y-auto">
          ...
          <CardContent className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
              <div>
                ...
                <select className="w-full border border-gray-300 rounded-md px-2 py-1.5 bg-white text-gray-800 text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
              ...
              <div className="flex items-end space-x-1">
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-2 py-1.5 rounded-md font-medium transition-colors flex-1 cursor-pointer text-xs whitespace-nowrap">
                  🔍 Áp dụng
                </button>
                <button className="bg-gray-500 hover:bg-gray-600 text-white px-2 py-1.5 rounded-md font-medium transition-colors flex-1 cursor-pointer text-xs whitespace-nowrap">
                  🔄 Đặt lại
                </button>
              </div>
            </div>
        ...
        <Card>
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">24 nội dung đang chờ xử lý</p>
          </div>
          ...
          <div className="bg-white px-6 py-3 border-t border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button className="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">
                  Trước
                </button>
                <button className="px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-blue-600 rounded-md cursor-pointer">
                  1
                </button>
                <button className="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">
                  2
