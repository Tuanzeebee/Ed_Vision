          ...
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <button 
                  onClick={handleToday}
                  className="px-3 py-1.5 text-xs font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 cursor-pointer transition-colors"
                >
                  Hôm nay
                </button>
              </div>
                ...
                {upcomingTotalPages > 1 && (
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                    <div className="text-sm text-gray-600">
                      Hiển thị <span className="font-medium">{(upcomingPage - 1) * 5 + 1}-{Math.min(upcomingPage * 5, upcomingTotal)}</span> trong tổng số <span className="font-medium">{upcomingTotal}</span> cuộc hẹn
                    </div>
              ...
              <>
                ...
                {historyTotalPages > 1 && (
                  <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
                    <div className="text-sm text-gray-600">
                      Hiển thị <span className="font-medium">{(historyPage - 1) * 10 + 1}-{Math.min(historyPage * 10, historyTotal)}</span> trong tổng số <span className="font-medium">{historyTotal}</span> cuộc hẹn
                    </div>
                    <div className="flex items-center space-x-2">
                      <button 
