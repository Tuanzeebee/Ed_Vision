  ...
  return (
    <AdminLayout>
      <div className="p-6 bg-gray-50 overflow-y-auto">
        <PermissionHeader 
          activeTab="account"filters={filters}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <Card>
            ...
            <div className="max-h-80 overflow-y-auto relative"style={{ minHeight: isLoading ? '200px': 'auto'}}>
              {isLoading && (
                <LoadingSpinner 
                  text="Đang tải danh sách tài khoản..."size="md"position="center"/>)}
                ...
                <div
                  ...
                  className={`p-4 border-b border-gray-200 cursor-pointer transition-colors ${
                    selectedUser === user.id 
                      ? 'bg-blue-50 border-l-4 border-l-blue-500': 'hover:bg-gray-50'}`}
                >
              ...
              <div className="space-y-3">
                {permissions.map((permission, index) =>(
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <input 
                        type="checkbox"checked={permission.granted}
                        className={`w-4 h-4 border-gray-300 rounded focus:ring-2 ${
                          permission.type === 'Override'? 'text-orange-600 focus:ring-orange-500': permission.granted 
                              ? 'text-blue-600 focus:ring-blue-500': 'text-gray-400 focus:ring-gray-500'}`}
                        onChange={() => {}}
                      />
                      <div>
