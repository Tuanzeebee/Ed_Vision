...
export default function AdminOverviewDashboard() {
    ...
    const fetchDashboardStats = async () => {
      ...
      try {
        ...
        setFilteredData({
          ...
          performance: {
            student: statsResponse.current.performance.student,
            instructor: statsResponse.current.performance.instructor,
          },
  ...
  // Access time chart data - 3 periods only (no noon)
        ...
        {!isLoading && (
          <>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {filteredData?.comparison?.students && (
                    <p className={`text-xs font-medium mt-1 flex items-center ${filteredData.comparison.students.trend === 'up'
                      ? 'text-green-600'
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {filteredData?.comparison?.instructors && (
                    <p className={`text-xs font-medium mt-1 flex items-center ${filteredData.comparison.instructors.trend === 'up'
                      ? 'text-green-600'
            ...
            <SimpleCard className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 p-4">
              ...
              {/* Two columns: Student on left, Instructor on right */}
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-white/50 rounded-lg p-2">
                  ...
                  <p className="text-xl font-bold text-purple-900">
                    {filteredData?.performance?.student?.toFixed(1) || '0.0'}%
                  </p>
                </div>
                ...
                <div className="bg-white/50 rounded-lg p-2">
                  ...
                  <p className="text-xl font-bold text-purple-900">
                    {filteredData?.performance?.instructor?.toFixed(1) || '0.0'}%
                  </p>
                </div>
              </div>

              {/* Average of both (optional) */}
              <div className="mt-2 pt-2 border-t border-purple-200">
                <p className="text-xs text-purple-700 font-medium text-center">
                  Trung bình chung: {' '}
                  <span className="text-sm font-bold">
                    {filteredData?.performance
                      ? (((filteredData.performance.student + filteredData.performance.instructor) / 2).toFixed(1))
                      : '0.0'}%
                  </span>
                </p>
              </div>
