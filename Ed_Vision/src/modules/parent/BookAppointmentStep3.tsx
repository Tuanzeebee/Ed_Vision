              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2 w-full max-w-sm">
                    ...
                    <Input
                      type="tel"placeholder={t('parent:bookAppointment.step3.phoneNumberPlaceholder')}
                  ...
                  <div className="space-y-2 w-full max-w-sm">
                    ...
                    <Input
                      type="email"placeholder={t('parent:bookAppointment.step3.emailAddressPlaceholder')}
