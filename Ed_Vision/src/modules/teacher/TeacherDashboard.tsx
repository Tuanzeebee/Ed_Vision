...
import {
    ...
    FileBarChart,
    ClipboardList
} from "lucide-react"// Asset imports
            ...
            <div className="flex pt-20">
                ...
                <aside className="w-64 bg-white border-r border-gray-200 shadow-sm fixed left-0 top-20 bottom-0 overflow-y-auto">
                    <nav className="p-4 space-y-2">
                        <button onClick={() => onNavigate('dashboard')} className="flex items-center space-x-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-lg w-full text-left">
                            <MoreHorizontal className="w-5 h-5" />
                            <span>Dashboard</span>
                        </button>
                        <button onClick={() => onNavigate('class-management')} className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg w-full text-left">
                            <BookOpen className="w-5 h-5" />
                            <span>Quản lý lớp học</span>
                        </button>
                        <button onClick={() => onNavigate('grade-management')} className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg w-full text-left">
                            <ClipboardList className="w-5 h-5" />
                            <span>Quản lý điểm</span>
                        </button>
                        <button onClick={() => onNavigate('progress-tracking')} className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg w-full text-left">
                            <TrendingUp className="w-5 h-5" />
                            <span>Theo dõi tiến độ</span>
                        </button>
                        <button onClick={() => onNavigate?.('reports-alerts')} className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg w-full text-left">
                        ...
                        <Card>
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    ...
                                    <Badge variant="destructive" className="text-xs">30 sinh viên</Badge>
                                </div>
                            </CardHeader>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Badge variant="destructive" className="text-xs">4 SV</Badge>
                                        </TableCell>
                                        <TableCell>
                                            <Badge variant="secondary" className="bg-green-100 text-green-800">Đang học</Badge>
                                        </TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Badge variant="outline" className="bg-orange-100 text-orange-800 border-orange-200">7 SV</Badge>
                                        </TableCell>
                                        <TableCell>
                                            <Badge variant="secondary" className="bg-green-100 text-green-800">Đang học</Badge>
                                        </TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Badge variant="secondary" className="bg-green-100 text-green-800">2 SV</Badge>
                                        </TableCell>
                                        <TableCell>
                                            <Badge variant="secondary" className="bg-green-100 text-green-800">Đang học</Badge>
                                        </TableCell>
