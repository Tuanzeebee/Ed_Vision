...
export default function ClassManagement({ onNavigate }: Props) {
    const initialData = [
        {
            id: "IT01-2024",
            name: "Lập trình Web",
            ...
            <header className="bg-white border-b border-gray-200 shadow-sm fixed top-0 left-0 right-0 z-50">
                <div className="flex items-center justify-between px-6 py-4">
                    <div className="flex items-center space-x-4">
                        ...
                        <h1 className="text-xl font-bold text-blue-900">Giảng viên Dashboard</h1>
                    </div>
            ...
            <div className="flex pt-20">
                ...
                <aside className="w-64 bg-white border-r border-gray-200 shadow-sm fixed left-0 top-20 bottom-0 overflow-y-auto">
                    <nav className="p-4 space-y-2">
                        <button onClick={() => onNavigate('dashboard')} className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg w-full text-left">
                            <MoreHorizontal className="w-5 h-5" />
                            <span>Dashboard</span>
                        </button>
                        <button onClick={() => onNavigate('class-management')} className="flex items-center space-x-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-lg w-full text-left">
