        ...
        <Card className="bg-white rounded-xl shadow-lg">
          <CardContent className="p-6 sm:p-7">
            ...
            <div className="text-center mb-6">
              <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">SCORE PREDICT
              </h1>
            </div>

            {/* Title */}
            <div className="text-center mb-5">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-1">Create Your Account
              </h2>
            </div>

            {/* Instruction Text */}
            <div className="text-center mb-6">
              <p className="text-gray-600 text-sm leading-relaxed">We have sent the confirmation code to email:{''}
                <span className="font-semibold text-gray-800">{email}</span>
                <br />Please check your email and enter the 4-digit OTP code.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* OTP Input */}
              <div>
                <label htmlFor="otp"className="block text-sm font-medium text-gray-700 mb-2">Enter your code
                </label>
              ...
              <div className="text-center">
                {isResendDisabled ? (
                  <>
                    <p className="text-xs text-gray-600 mb-2">Code not received, resend in{''}
                      <span className="font-semibold text-gray-800">{countdown}s</span>
                    </p>
                    <button type="button"className="text-xs text-gray-400 cursor-not-allowed"disabled>Resend
                    </button>
                  </>) : (
                  <>
                    ...
                    <button
                      ...
                      className="text-xs text-purple-600 hover:text-purple-700 cursor-pointer transition-colors duration-200">Resend Code
                    </button>
                  </>)}
              </div>
              ...
              {/* Continue Button */}
              <Button
                type="submit"className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold py-2.5 px-5 rounded-lg hover:from-purple-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-[1.02]">Continue
              </Button>
            </form>
            ...
            <div className="text-center mt-5">
              <p className="text-sm text-gray-600">Already have an account?{''}
                <button
                  ...
                  className="font-semibold text-purple-600 hover:text-purple-700 transition-colors duration-200">Log in
                </button>
              </p>
            </div>
          </CardContent>
