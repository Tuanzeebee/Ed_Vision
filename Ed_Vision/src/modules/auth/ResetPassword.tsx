          ...
          <Card className="bg-white rounded-xl shadow-md">
            <CardContent className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="code"className="block text-sm font-medium text-gray-700 mb-2">Verification Code
                  </label>
                ...
                {/* New Password Input */}
                <div>
                  <label htmlFor="newPassword"className="block text-sm font-medium text-gray-700 mb-1">New Password
                  </label>
                  <div className="relative">
                    <Input
                      ...
                      minLength={6}
                      placeholder="Enter your new password"className="text-sm text-gray-900 placeholder-gray-400 pr-10"/>
                    <button
                ...
                <div>
                  <label htmlFor="confirmPassword"className="block text-sm font-medium text-gray-700 mb-1">Confirm New Password
                  </label>
                  <div className="relative">
                    <Input
                      ...
                      minLength={6}
                      placeholder="Confirm your new password"className="text-sm text-gray-900 placeholder-gray-400 pr-10"/>
                    <button
              ...
              <div className="mt-4 text-center">
                <p className="text-xs text-gray-600">Didn't receive the code?{''}
                  <button 
              ...
              {/* Footer Links */}
              <div className="mt-4 text-center">
                <p className="text-xs text-gray-600">Remember your password?{''}
                  <button 
                    onClick={handleLogin}
                    className="text-purple-600 hover:text-purple-700 font-medium cursor-pointer">Back to Login
                  </button>
                </p>
              </div>
            </CardContent>
