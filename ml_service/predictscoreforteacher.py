...
ARTIFACTS_PATH = os.path.join(OUTPUT_DIR, "model_artifacts_gb_rf.joblib")
...
# =============================
# 4. Chuẩn hóa 1 file course (từ DataFrame)
# =============================
...
# =============================
# 5. Build X cho inference từ df đã chuẩn hóa
# =============================
...
# =============================
# 6. Load model artifacts & weights khi server start
# =============================
...
async def predict_from_csv(file: UploadFile = File(...)):
    ...
    df_features["confidence_level"] = "high"  # hoặc "none" nếu bạn không muốn dùng notion này
